...
$acc_username = "RennaMae";
$acc_password = "Regio12345";
$acc_fullname = "Renna Mae Regio";
$acc_address = "Tanza Boac Marinduque PH";
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			if(isset($_REQUEST['notexist']) ===true){
		      				...
		      				echo "<div class='alert alert-danger' role='alert'> You are still logged in. Please click <a href='account.php'> here to proceed. </div>";
		      			}
